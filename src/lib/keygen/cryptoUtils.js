...
export class Crc32 {
    static IEEE_POLYNOMIAL = 0xEDB88320;
    static tableCache = {};
...
export class Crc64 {
    static ECMA_POLYNOMIAL = JSBI.BigInt("14514072000185962306");
    static tableCache = {};

    constructor(poly, table) {
        this.polynom = poly;
...
export class Sha256 {
    static SHA256_CONSTANTS = Uint32Array.from([
    ...
    static SHA256_IV = Uint32Array.from([
...
export class AES128 {
    ...
    static addRoundKey(round, state, roundKey) {
        for (let i = 0; i < 4; i++) {
            for (let j = 0; j < 4; j++) {
